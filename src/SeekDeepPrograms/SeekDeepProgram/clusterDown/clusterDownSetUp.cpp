...
//				"If Singlets are left out, map them back in for frequency estimates");
	...
	setOption(pars_.chiOpts_.posSpacing_, "--chiPosSpacing", "The amount of shared sequence inbetween difference to consider a sequence a chimera of two parent sequences", false, "Chimeras");
